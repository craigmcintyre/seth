 ...
 * error code.
 */
public class FailureErrorCodeExpectedResult extends ExpectedResult
{
   ...
   */
  public FailureErrorCodeExpectedResult(String description, OperationMetadata opMetadata,
                                        AppContext appContext, Options options, int expectedErrCode)
  {
    super(ExpectedResultType.FAILURE_CODE, description, opMetadata, appContext, options);
  ...
  public void assertActualAsResultSet(ExecutionContext xContext, ResultSet rs, SQLWarning warnings) throws FailureException
  {
    ...
    final String commentDesc = "A ResultSet was returned instead of an error code.";
  ...
  public void assertActualAsUpdateCount(ExecutionContext xContext, long updateCount, SQLWarning warnings) throws FailureException
  {
    ...
    final String commentDesc = "An affected row count was returned instead of an error code.";
  ...
  public void assertActualAsException(ExecutionContext xContext, Exception e) throws FailureException
  {
    ...
    final String commentDesc = "An exception was returned instead of an error code.";
