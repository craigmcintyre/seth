...
public class FailureErrorMsgSuffixExpectedResult extends ExpectedResult
{
  ...
  public FailureErrorMsgSuffixExpectedResult(String description, OperationMetadata opMetadata,
                                             AppContext appContext, Options options, String expectedErrMsg)
  {
    super(ExpectedResultType.FAILURE_MSG_SUFFIX, description, opMetadata, appContext, options);
  ...
  public void assertActualAsException(ExecutionContext xContext, Exception e) throws FailureException
  {
    ...
    if (!e.getMessage().trim().endsWith(expectedErrMsg)) {
  ...
  public void assertActualAsFailure(ExecutionContext xContext, String msg) throws FailureException
  {
    ...
    if (!msg.trim().endsWith(expectedErrMsg)) {
      // The error messages differ.
      final String commentDesc = "A different error message was received than was expected.";
